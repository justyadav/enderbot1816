...
# --- REUSABLE SYSTEM PALETTE ---
COLOR_PRIMARY = discord.Color.blurple()       # Main Headers and Launch Actions
COLOR_SUCCESS = discord.Color.green()         # Activation / System Claim Confirmation
COLOR_WARNING = discord.Color.from_rgb(255, 191, 0) # Valid pure RGB Amber
COLOR_DANGER = discord.Color.red()            # Deletions / Lockdowns / Closures
COLOR_DARK = discord.Color.from_rgb(34, 36, 41) # High-Contrast Sleek Dashboard Background

# Upgraded Branding Definitions
...
class TicketControls(discord.ui.View):
    def __init__(self):
        super().__init__(timeout=None)  # Global persistence across restarts

    @discord.ui.button(label="Claim Ticket", style=discord.ButtonStyle.success, custom_id="kite_pub_claim_btn", emoji="🙋‍♂️", row=0)
    async def claim(self, interaction: discord.Interaction, button: discord.ui.Button):
        if not interaction.user.guild_permissions.manage_channels:
            return await interaction.response.send_message("❌ You lack server operational clearance (`Manage Channels`) to claim this case.", ephemeral=True)
